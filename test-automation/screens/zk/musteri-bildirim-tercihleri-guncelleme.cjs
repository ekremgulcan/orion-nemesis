 ...
 * ekraninda kapsamli fonksiyonel test - V40 kategori-bazli rework sonrasi:
 *   1. Var olmayan bir Musteri No aranir -> hata mesaji gorunur, tercih
 *      paneli gizli kalir.
 *   2. Var olan bir Musteri No aranir -> Musteri Bilgileri paneli ve 2
 ...
 *      kilitli/disabled oldugu dogrulanir (mevzuatsal zorunlu kategori).
 *   4. Duzenlenebilir ORDER_STATUS satirinin Push ve SMS tercihleri
 *      kapatilir, "Onaya Gonder" ile kaydedilir -> basari mesaji +
...
async function run() {
  ...
  try {
    ...
    // kolonuna gore) x 3 checkbox (Push, SMS, E-Posta) = 6 checkbox; son 3
    ...
    // index 0 = ORDER_STATUS Push, index 1 = SMS, index 2 = E-Posta
