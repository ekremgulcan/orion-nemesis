-- =============================================================
-- V32: Bildirim Izleme mock veri
-- Gercekci emir bildirimi log kayitlari: bir kismi bugun (Bugunku
-- Bildirimler tab'i icin), bir kismi son 10 gun icinde (Gecmis
-- Bildirimler tab'i icin). Hesap/kullanici referanslari V5'te
-- seed edilen gercek kayitlara isaret eder (accounts.account_id
-- 1-13 -> hesap_no 10001-10013, users.user_id 1-5).
-- =============================================================
