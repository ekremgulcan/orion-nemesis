...
const rawMenuItems: RawMenuItem[] = [
  ...
  {
    label: "Yeni Hisse Emir Yonetimi",
    path: "/risk/hisse-risk-parametreleri",
    implemented: true,
    children: [
      { label: "Hisse Risk Parametreleri", path: "/risk/hisse-risk-parametreleri", implemented: true },
      { label: "Kullanici Limit Tanimlama", implemented: false },
      { label: "Hisse Grubu Tanimlama", path: "/risk/hisse-grubu-tanimlama", implemented: true },
      { label: "Kullanici/Hesap/Hisse Bazinda Kontrol", path: "/risk/hesap-hisse-kontrol", implemented: true },
      { label: "Kisisel Kullanici Limiti", implemented: false },
      { label: "Sabit Getiri Risk Tanimlama", implemented: false },
      { label: "Sabit Getiri Kullanici Limiti", implemented: false },
